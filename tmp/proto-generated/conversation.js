...
export const yh_conversation = $root.yh_conversation = (() => {
    ...
    yh_conversation.ConversationList = (function() {
        ...
        ConversationList.ConversationData = (function() {
             ...
             * @property {number|Long|null} [unreadMessage] ConversationData unreadMessage
             ...
             * @member {number|Long} unreadMessage
             * @memberof yh_conversation.ConversationList.ConversationData
             * @instance
             */
            ConversationData.prototype.unreadMessage = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
            ...
            ConversationData.encode = function encode(message, writer, _depth) {
                ...
                if (message.unreadMessage != null && Object.hasOwnProperty.call(message, "unreadMessage"))
                    writer.uint32(/* id 6, wireType 0 =*/48).int64(message.unreadMessage);
            ...
            ConversationData.verify = function verify(message, _depth) {
                ...
                if (message.unreadMessage != null && message.hasOwnProperty("unreadMessage"))
                    if (!$util.isInteger(message.unreadMessage) && !(message.unreadMessage && $util.isInteger(message.unreadMessage.low) && $util.isInteger(message.unreadMessage.high)))
                        return "unreadMessage: integer|Long expected";
            ...
            ConversationData.fromObject = function fromObject(object, _depth) {
                ...
                if (object.unreadMessage != null)
                    if (typeof object.unreadMessage === "object" ? object.unreadMessage.low || object.unreadMessage.high : Number(object.unreadMessage) !== 0)
                        if ($util.Long)
                            message.unreadMessage = $util.Long.fromValue(object.unreadMessage, false);
                        else if (typeof object.unreadMessage === "string")
                            message.unreadMessage = parseInt(object.unreadMessage, 10);
                        else if (typeof object.unreadMessage === "number")
                            message.unreadMessage = object.unreadMessage;
                        else if (typeof object.unreadMessage === "object")
                            message.unreadMessage = new $util.LongBits(object.unreadMessage.low >>> 0, object.unreadMessage.high >>> 0).toNumber();
                if (object.at != null)
            ...
            ConversationData.toObject = function toObject(message, options, _depth) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        let long = new $util.Long(0, 0, false);
                        object.unreadMessage = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : typeof BigInt !== "undefined" && options.longs === BigInt ? long.toBigInt() : long;
                    } else
                        object.unreadMessage = options.longs === String ? "0" : typeof BigInt !== "undefined" && options.longs === BigInt ? BigInt("0") : 0;
                    object.at = 0;
                    if ($util.Long) {
                        let long = new $util.Long(0, 0, false);
                ...
                if (message.unreadMessage != null && message.hasOwnProperty("unreadMessage"))
                    if (typeof BigInt !== "undefined" && options.longs === BigInt)
                        object.unreadMessage = typeof message.unreadMessage === "number" ? BigInt(message.unreadMessage) : $util.Long.fromBits(message.unreadMessage.low >>> 0, message.unreadMessage.high >>> 0, false).toBigInt();
                    else if (typeof message.unreadMessage === "number")
                        object.unreadMessage = options.longs === String ? String(message.unreadMessage) : message.unreadMessage;
                    else
                        object.unreadMessage = options.longs === String ? $util.Long.prototype.toString.call(message.unreadMessage) : options.longs === Number ? new $util.LongBits(message.unreadMessage.low >>> 0, message.unreadMessage.high >>> 0).toNumber() : message.unreadMessage;
                if (message.at != null && message.hasOwnProperty("at"))
